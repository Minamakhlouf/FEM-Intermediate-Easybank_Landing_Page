...
export default function Footer() {
    return (
        <footer className={`bg-[#2d314d] py-[2.5rem] flex justify-center`}>
            <div className={`w-[87.2%] flex flex-col items-center gap-[2rem] lg:flex-row lg:max-w-[1110px] lg:gap-[10rem]`}>
                ...
                <div className="flex flex-col items-center gap-[1.5rem] lg:ml-auto">
                    <Button/>
                    <p className="text-sm text-center text-gray-400">&copy; Easybank. All Rights Reserved.</p>                         
                </div>
            </div>
        </footer>
    )
